...
phone_list = ['(0121 123 4567', '(0121) 123 4567', '0121 123 4567', '0121 123 4567 ext. 8000', '0121) 123 4567 ext. 890', '01211 234567', '(01 21) 12 34 567', '01211234567', '01211 234567', '01 211 23 45 67']
...
re_ex = "(?:(\((01[2-6]1)\))|(01[2-6]1))\s\d{3}\s\d{4}\sext\.\s\d{1,4}$"
run_re(re_ex, phone_list)
...
re_ex = "(?:(\((01\s?[2-6]\s?1)\))|(01\s?[2-6]\s?1))\s?([0-9]|\s){3,5}([0-9]|\s){4,7}$"
run_re(re_ex, phone_list)

re_ex = "(?:(\((01\s?[2-6]\s?1)\))|(01\s?[2-6]\s?1))\s?(\d|\s){3,5}(\d|\s){4,7}$"
run_re(re_ex, phone_list)
